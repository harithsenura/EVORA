...
export function TruckButton({ onClick, disabled = false, className = "", children }: TruckButtonProps) {
  ...
  useEffect(() => {
    ...
    const handleClick = (e: Event) => {
      ...
      let box = button.querySelector('.box') as HTMLElement
      let truck = button.querySelector('.truck') as HTMLElement
            ...
            onComplete() {
              gsap.timeline({
                onComplete() {
                  ...
                  // Call the onClick handler after animation completes
                  if (onClick) {
                    onClick()
                  }
                }
    ...
    <>
      <style jsx>{`
        .truck-button {
          ...
          --back: #d97706;
          --back-inner: #b45309;
          --back-inner-shadow: #92400e;
          --front: #fbbf24;
          --front-shadow: #d97706;
          --front-light: #fef3c7;
          --window: #92400e;
          --window-shadow: #78350f;
          --street: #a16207;
          --street-fill: #92400e;
          --box: #f59e0b;
          --box-shadow: #d97706;
